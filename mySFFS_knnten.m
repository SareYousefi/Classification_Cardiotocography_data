function [sel,performance] = mySFFS_knnten(datatrain,dtrain,datatest,dtest)
...
for iter=1:size(datatrain,1)
    ...
    for i=indx
        ...
        mdl= fitcknn(datatrainv_cond',dtrain,'NumNeighbors',1,'Distance','Cityblock','Standardize',1);
